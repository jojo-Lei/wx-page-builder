<template>
    <div class="components-control-bar">
        ...
        <UploadPsd @upload-success="uploadSuccessPsd">
         ...
         <div class="button-item"  @click="save">
            <i class="iconfont inconbaocun"></i>
            <p>保存</p>
        </div>
        <div class="button-item"  @click="publishFn">
            <i class="iconfont inconfabu"></i>
            <p>发布</p>
        </div>
        <div class="button-item"  @click="cancelFn">
            <i class="iconfont incontuichu"></i>
            <p>退出</p>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        updataScale(type, value){
            ...
            this.$emit('updata:scale', this.scaleValue);
        },
        /**
         * 获取psd数据
         */
