                    ...
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-for="(item, index) in eventTypeList" :key="index" >
                                <div  @click="addEvent(item)">{{item.label}}</div>
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                    <p class="gray inline-block fontsize-12 marginL10">事件在编辑状态下无效果</p>
                </div>
                    ...
                    <el-collapse accordion>
                        <el-collapse-item v-for="(item,index) in activeElement.events" :key="index">
                            <template slot="title">
                                ...
                                <span class="el-animate-title-btn" @click.stop.prevent="deleteEvent(index)">
                            ...
                            <div class="el-animate-item">
                                <div class="attr-item-edit-wrapper" v-show="item.type !== 'share'">
                                    ...
                                    <div class="col-1 attr-item-edit-input">
                                        <el-input type="textraea" :rows="3" placeholder="请输入url" v-model="item.url"></el-input>
                                    </div>
                                </div>
                            </div>
                        </el-collapse-item>
