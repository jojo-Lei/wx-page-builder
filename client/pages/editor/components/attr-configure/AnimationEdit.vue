                ...
                <el-collapse-item v-for="(item, index) in activeElement.animations" :key="index">
                  <template slot="title">
                    <span class="el-animate-title-name">动画{{index}}</span>
                      <div class="el-animate-title-type-wrapper">
                        <span class="el-animate-title-type" @click.stop.prevent="handleShowChooseAnimatePane(index)">
                                {{item.type}} <i class="el-icon-caret-right size-mini"></i>
                        </span>
                         </div>
                            <span class="el-animate-title-btn" @click.stop.prevent="ranAnimate(index)">
                               <i class="el-icon-caret-right"></i>
                            </span>
                            <span class="el-animate-title-bt" @click.stop.prevent="handleDeleteAnimate">
                  ...
                  <div class="el-animate-item">
                    <div class="attr-item-edit-wrapper">
                        ...
                        <div class="col-2 attr-animate-edit-input">
                          <el-input-number size="mini" v-model="item.duration" 
                                          controls-position="right" :min="1" :step="0.1" >
                          </el-input-number>
                        </div>
                        </div>
                          <div class="attr-item-edit-wrapper">
                            ...
                            <div class="col-2 attr-animate-edit-input">
                              <el-input-number size="mini" v-model="item.delay" 
                                            	controls-position="right" :min="1" :step="0.1" >
                              </el-input-number>
                          </div>
                          </div>
...
<script>
import animateCssData from '@client/assets/animateCssData'
