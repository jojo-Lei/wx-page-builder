                ...
                <div class="attr-item-edit-wrapper">
                    ...
                    <div class="sizeAndPosition-wrapper">
                        ...
                        <div class="align-type-item clearFlex" @click="handleResizeClick('w')">
                            <el-tooltip effect="dark" content="宽度100%" placement="bottom">
...
import imageSelect from '@client/components/ImageSelect'
...
export default {
    ...
    watch:{
        ...
        activeNames(){
            this.$store.dispatch('updateActiveAttrEditCollapse',this.activeNames);
        }
    },
    created() {
